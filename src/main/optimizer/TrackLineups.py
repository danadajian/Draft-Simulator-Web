...
def ingest_actual_optimal_data(lineup_matrix, display_matrix, sport, site, slate, white_list, black_list, proj_dict,
    ...
    if slate == 'thurs':
        optimal_lineup = optimize_mvp(site, black_list, scores_dict, salary_dict, len(display_matrix),
                                      cap).get('lineup')
    else:
        optimal_lineup = optimize(lineup_matrix, white_list, black_list, scores_dict, pos_dict, salary_dict,
                                  cap).get('lineup')
