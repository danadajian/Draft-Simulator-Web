...
<html lang="en">
<head>
    <title id='Description'>This demo shows how to keep the expanded item of the navigation
        bar by using cookies.</title>
   ...
   <script type="text/javascript" src="../../../scripts/jquery-1.12.4.min.js"></script>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var index = $.jqx.cookie.cookie("jqxNavigationBar_jqxWidget");
            if (index == undefined) {
                index = 0;
            };
            $("#jqxNavigationBar").jqxNavigationBar({ width: 400, height: 520, expandMode: "single",  expandedIndexes: [index] });
            $('#jqxNavigationBar').on('expandedItem', function (event) {
                var expandedItem = event.args.item;
                $.jqx.cookie.cookie("jqxNavigationBar_jqxWidget", expandedItem);
            });
        });
    </script>
</head>
